    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="row p-3 black-block mx-1">
          <div className="col-6 col-md-2 text-nowrap">{children[0]}</div>
          <div className="col-6 col-md-2 text-nowrap">{children[1]}</div>
          <div className="col-6 col-md-2 text-nowrap">{children[2]}</div>
          <div className="col-6 col-md-2 text-nowrap">{children[3]}</div>
