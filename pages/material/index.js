...
export default function Material() {
  ...
  return (
    <>
      ...
      <MaterialLayout>
        <div
          data-name="strengthen"
          onClick={handleClick}
          className={`pointer p-2 ${
            select.select1 === "strengthen" && "frame active"
          }`}
        >
          強化
        </div>
        <div
          ...
          onClick={handleClick}
          className={`pointer p-2 ${
            select.select1 === "enchant" && "frame active"
          }`}
        >
          附魔
        </div>
        <div
          ...
          onClick={handleClick}
          className={`pointer p-2 ${
            select.select1 === "refine" && "frame active"
          }`}
        >
          精煉
        </div>
        <div
          ...
          onClick={handleClick}
          className={`pointer p-2 ${
            select.select1 === "protect" && "frame active"
          }`}
        >
          保護
        </div>
        <div
          ...
          onClick={handleClick}
          className={`pointer p-2 ${
            select.select1 === "repair" && "frame active"
          }`}
        >
          修復
        </div>
        <div
          ...
          onClick={handleClick}
          className={`pointer p-2 ${
            select.select1 === "other" && "frame active"
          }`}
        >
          寵物
        </div>
        <Slider {...settings}>
          {data.originaldata[select.select1]?.map((v, index) => (
            <div
              key={index}
              className={`material-card black-block m-2 text-center ${
                select.select2 === v && "active"
              }`}
              data-item={v}
              onClick={handleClick}
            >
        ...
        {data.monsterdata
          .filter((v) => v.item.includes(select.select2))
          .map((item, index) => (
            <div
              className={`black-block monster-card ${
                click?.name === item.name ? "active" : ""
              }`}
              key={index}
